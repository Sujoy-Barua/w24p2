...
public final class FakebookOracleMain {
    // Member Variables
    private static String username = "kevindw"; // replace with your uniqname
    private static String password = "Lmclakers1015!"; // replace with your Oracle password (default: eecsclass)
